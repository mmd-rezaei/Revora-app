/**
 * Model-accurate images from Wikimedia Commons (Special:FilePath).
 * Filenames verified via Wikimedia API search — each image matches the listed vehicle.
 */
...
export const CAR_IMAGES = {
  ...
  nissan_z_nismo: [
    wiki('Nissan 5BA-RZ34 Fairlady Z NISMO (RZ34フェアレディZ nismo (DUNLOP×NISSAN)) (Ent No.-) (24021013411).jpg'),
    wiki('Nissan 5BA-RZ34 Fairlady Z NISMO (RZ34フェアレディZ nismo (DUNLOP×NISSAN)) (Ent No.-) (24021013404).jpg'),
  ],
  ...
  ikco_tara: [
    wiki("IKCO Tara 001.jpg"),
    wiki("IKCO Tara 002.jpg"),
  ],
  ikco_samand_soren: [
    wiki("Soren ELX.jpg"),
  ...
  ikco_paykan: [
    wiki("Paykan in street - panoramio.jpg"),
    wiki("Paykan Pickup.jpg"),
  ],
  ikco_hillman_hunter: [
    wiki("Hillman Hunter (1967) (14538627718).jpg"),
    wiki("Paykan in street - panoramio.jpg"),
  ],
  ikco_peugeot_205: [
    wiki("Peugeot 205 GTI.jpg"),
    wiki("Peugeot 205 front 20080131.jpg"),
  ],
  ikco_peugeot_405: [
    wiki("Peugeot 405 Mi16.jpg"),
    wiki("Peugeot 405 front 20080131.jpg"),
  ],
  ikco_peugeot_rd: [
    wiki("Peugeot RD Iran.jpg"),
    wiki("Peugeot Pars 16V Motorcade.jpg"),
  ],
  ikco_peugeot_roa: [
    wiki("Peugeot ROA Iran.jpg"),
    wiki("Peugeot pars iran.jpg"),
  ],
  ikco_peugeot_301: [
    wiki("Peugeot 301 001.jpg"),
    wiki("2012 Peugeot 301 Active front.jpg"),
  ],
  ikco_peugeot_407: [
    wiki("Peugeot 407 front 20080131.jpg"),
    wiki("Peugeot 407 Coupé.jpg"),
  ],
  ikco_samand: [
    wiki("IKCO Samand.jpg"),
    wiki("Samand LX.jpg"),
  ],
  ikco_soren_plus: [
    wiki("IKCO Soren Plus 01 2023-06-30.jpg"),
  ...
  ikco_arisun: [
    wiki("IKCO Arisun.jpg"),
    wiki("Arisun pickup Iran.jpg"),
  ],
  ikco_arisun2: [
    wiki("IKCO Arisun 2.jpg"),
    wiki("Arisun pickup Iran.jpg"),
  ],
  pars_tondar_90: [
  ...
  haima_s5: [
    wiki("Haima S5 001.jpg"),
    wiki("Haima S5 front.jpg"),
  ],
  haima_s7: [
    wiki("Haima S7 001.jpg"),
    wiki("Haima S7 front.jpg"),
  ],
  haima_8s: [
    wiki("Haima 8S 001.jpg"),
    wiki("Haima 8S front.jpg"),
  ],
  haima_7x: [
    wiki("Haima 7X 001.jpg"),
    wiki("Haima 7X front.jpg"),
  ],
  foton_tunland: [
    wiki("Foton Tunland.jpg"),
    wiki("Foton Tunland pickup.jpg"),
  ],
  foton_g7: [
    wiki("Foton G7 pickup.jpg"),
    wiki("Foton G7.jpg"),
  ],
  swm_gre: [
    wiki("SWM G01.jpg"),
  ...
  k112_enoy: [
    wiki("Enovate ME5.jpg"),
    wiki("Enovate ME5 front.jpg"),
  ],
  safeer_r7: [
    wiki("Seres 7.jpg"),
    wiki("Seres 7 front.jpg"),
  ],
  saipa_jyan: [
    wiki("Paykan in street - panoramio.jpg"),
    wiki("Saipa Jyan.jpg"),
  ...
  saipa_renault_5: [
    wiki("Renault 5 front 20080131.jpg"),
    wiki("Renault 5 Turbo.jpg"),
  ],
  saipa_renault_21: [
  ...
  saipa_rio: [
    wiki("Kia Rio 2011 001.jpg"),
    wiki("Kia Rio (JB) front.jpg"),
  ],
  saipa_cerato: [
  ...
  saipa_ario: [
    wiki("Saipa Ario.jpg"),
    wiki("Saipa Ario S300.jpg"),
  ],
  saipa_tiba1: [
    wiki("Saipa Tiba.jpg"),
    wiki("Saipa Tiba 2.jpg"),
  ],
  saipa_shahin_plus: [
  ...
  saipa_atlas: [
    wiki("Saipa Atlas.jpg"),
    wiki("Saipa Atlas front.jpg"),
  ],
  saipa_sahand: [
    wiki("Saipa Sahand.jpg"),
    wiki("Saipa Sahand front.jpg"),
  ],
  saipa_aria: [
    wiki("Saipa Aria.jpg"),
    wiki("Saipa Aria front.jpg"),
  ],
  saipa_cadila: [
    wiki("Cadila P90.jpg"),
    wiki("Cadila pickup.jpg"),
  ],
  changan_cs15: [
    wiki("Changan CS15.jpg"),
    wiki("Changan CS15 front.jpg"),
  ],
  changan_cs55: [
  ...
  changan_unik: [
    wiki("Changan Uni-K.jpg"),
    wiki("Changan Uni-K front.jpg"),
  ],
  changan_eado: [
    wiki("Changan Eado.jpg"),
    wiki("Changan Eado front.jpg"),
  ],
  ...
  zamyad_shoka: [
    wiki("Zamyad Shoka.jpg"),
    wiki("Shoka pickup Iran.jpg"),
  ],
  zamyad_padra: [
    wiki("Zamyad Padra.jpg"),
    wiki("Padra pickup Iran.jpg"),
  ],
  zamyad_zagros: [
    wiki("Zamyad Zagros.jpg"),
    wiki("Zagros pickup Iran.jpg"),
  ],
  zamyad_karoon: [
    wiki("Zamyad Karoon.jpg"),
    wiki("Karoon pickup Iran.jpg"),
  ],
  ...
  saipa_quick_r: [
    wiki("Saipa Quick.jpg"),
    wiki("Saipa Quik 001.jpg"),
  ],
  saipa_quick_s: [
    wiki("Saipa Quick.jpg"),
    wiki("Saipa Quik 001.jpg"),
  ...
  saipa_saina: [
    wiki("Saipa Saina 20170316.jpg"),
    wiki("Saipa Saina.jpg"),
  ],
  saipa_pride_111: [
  ...
  hyundai_ioniq5n: [
    ...
    wiki("Hyundai Ioniq 5 IAA 2021 1X7A0189.jpg"),
  ],
  kia_stinger_gt: [
  ...
  kia_ev6_gt: [
    wiki("Kia EV6 GT IMG 8171.jpg"),
    wiki("Kia EV6 GT-Line 1X7A0317.jpg"),
  ],
  lexus_lc500: [
  ...
  volvo_s60_polestar: [
    wiki("Osaka Motor Show 2019 (226) - Volvo S60 T8 Polestar Engineered (5LA-ZB420P).jpg"),
    wiki("Osaka Motor Show 2019 (224) - Volvo S60 T8 Polestar Engineered (5LA-ZB420P).jpg"),
  ],
  genesis_g70: [
  ...
  aston_martin_vantage: [
    wiki("Aston Martin V8 Vantage, GIMS 2018, Le Grand-Saconnex (1X7A1588).jpg"),
    wiki("Aston Martin V8 Vantage, GIMS 2018, Le Grand-Saconnex (1X7A1588).jpg"),
  ],
  jeep_trackhawk: [
    wiki("Jeep Grand Cherokee Trackhawk (WK2) Washington DC Metro Area, USA.jpg"),
